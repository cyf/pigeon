      ...
      <div className="w-full max-w-xl px-5 xl:px-0">
        {post && (
          <Link
            href={`/${post.slug}`}
            rel="noreferrer"
            className="mx-auto mb-12 flex max-w-fit animate-fade-up items-center justify-center space-x-2 overflow-hidden rounded-full bg-[#2262af] bg-opacity-10 px-7 py-2 text-[#2262af] transition-colors hover:bg-opacity-20 dark:bg-opacity-20 dark:hover:bg-opacity-30"
          >
        ...
        <p
          className="mt-6 animate-fade-up text-center text-[#2262af] opacity-0 md:text-xl"
