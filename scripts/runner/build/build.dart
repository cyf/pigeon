...
const executableName = 'ep';
const packageName = 'expert_planet';
...
/// ```
/// {@endtemplate}
class BuildCliCommandRunner extends CompletionCommandRunner<int> {
  /// {@macro command_runner}
  BuildCliCommandRunner({
    Logger? logger,
